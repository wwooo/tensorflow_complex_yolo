...
from utils.kitti_utils import draw_rotate_rec, get_corner_gtbox
img_h, img_w = 768, 1024
gtbox_color = (255, 255, 255)
class_list = ['Car', 'Van', 'Truck', 'Pedestrian', 'Person_sitting', 'Cyclist', 'Tram', 'Misc']
dataset = ImageDataSet(data_set='test', mode='infer', flip=True, random_scale=True, load_to_memory=False)
